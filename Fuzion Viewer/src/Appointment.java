...
public class Appointment {
    ...
    // Data coming from Coverages Report
                ...
                for (CSVRecord adj : adjudicationsList){
                    if (adj.getRecordNumber() != 1) {
                        if (appointmentDate.compareTo(sdf.parse(adj.get(TABLE_ADJUDICATIONS_APPDATE))) == 0 && patientName.equalsIgnoreCase(adj.get(TABLE_ADJUDICATIONS_PATNAME).trim()) && 
                            ...
                            return adj.get(TABLE_ADJUDICATIONS_AMOUNT).isEmpty() ? 0.0 : Double.parseDouble(adj.get(TABLE_ADJUDICATIONS_AMOUNT));
                        }
                    }
                }
    ...
    private Object[][] getRowData(){
        ...
        records = controller.getAppointmentExportedData();
    ...
    public TableModel getTotalsTableModel(JTable table){
        String[] headers = new String[]{"Appointments", "Checked In", "No Show", "Units", "Appointment Charges",
        ...
        data[0][3] = unitSum;
        data[0][4] = chargesSum;
        data[0][5] = therapistChargesSum;
        data[0][6] = insReceivableSum;
        data[0][7] = patReceivableSum;
        data[0][8] = profitSum;
        data[0][9] = ((chargesSum - therapistChargesSum) * 100) / chargesSum;
